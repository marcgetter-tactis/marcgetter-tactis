...
switch ($env) {
  case 'dev':
    $memcache_servers = [['hostname' => 'staging-43171.prod.hosting.acquia.com']];
    break;
  case 'test':
    $memcache_servers = [['hostname' => 'staging-43171.prod.hosting.acquia.com']];
    break;
  case 'prod':
    $memcache_servers = [
      ['hostname' => 'web-43167.prod.hosting.acquia.com'],
      ['hostname' => 'web-43168.prod.hosting.acquia.com'],
    ];
    break;
  default:
...
$config = [
   ...
   */
  'technicalcontact_name' => 'John Cunningham',
  'technicalcontact_email' => 'john.cunningham@acquia.com',
   ...
   */
  'secretsalt' => 'oofteofe6jeca27xb2jmyxe819tp83sf',
   ...
   */
  'auth.adminpassword' => '$2y$10$2kWrXDRv4XthSoBBkjefB.ge.O8xTkYHby5ngsttSy6XxwxzNvOfq',
